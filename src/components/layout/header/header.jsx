        ...
        <div className="header__wrapper">
          ...
          <ul className="header__control">
            <li className="header__item">
              <Link className="header__link header__link--place" to={AppRoute.PLACE} aria-label="Place">
